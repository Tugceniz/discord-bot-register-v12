...
exports.run = async(client, message, args) => {
    ...
    if (x) {
        ...
        ${uye} kişisi "${name}" olarak Kayıt oldu.

        Bu üye daha bu isimlerle kayıt olmuş.
    ...
    if (!x) {
       ...
       Sunucuda olan etkinliklere katılmayı unutma. 
        ...
        ${uye} kişisinin ismi başarıyla \`${name}\` olarak değiştirildi, ${message.guild.roles.cache.get(config.erkek1)}  rolleri verildi.
